...
namespace SpriteDicing
{
    ...
    public class DicedSpriteAtlas : ScriptableObject
    {
        ...
        public DicedSprite GetSpriteContainName(string spriteName)
        {
            return dicedSprites.Find(sprite => sprite.Name.Contains(spriteName));
        }

        public List<DicedSprite> GetDicedSpriteList(){
            return dicedSprites;
        }
    }
}
