...
namespace SpriteDicing
{
    ...
    public class DicedSpriteEditor : Editor
    {
        ...
        private SerializedProperty atlasAsset;
        ...
        public override void OnInspectorGUI ()
        {
            ...
            if (GUILayout.Button(new GUIContent("Delete it"), EditorStyles.miniButton))
                DeleteItFromAtlas();
        ...
        void DeleteItFromAtlas(){
            //DestroyImmediate(TargetSprite, true);
        }
        ...
        {
            if(TargetSprite.AtlasTexture == null)
                return;
