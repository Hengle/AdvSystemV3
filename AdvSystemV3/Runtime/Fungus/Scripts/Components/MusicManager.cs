...
namespace Fungus
{
    ...
    public class MusicManager : MonoBehaviour
    {
        ...
        public void PlayMusic(AudioClip musicClip, bool loop, float fadeDuration, float atTime, bool SameSongAlsoReplay = false)
        {
            if(audioSourceMusic.clip == musicClip && !SameSongAlsoReplay)
            {
                print("Do not play because Same Music");
                return;
            }
            PlayMusic(musicClip, loop, fadeDuration, atTime);
        }
